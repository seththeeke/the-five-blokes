...
module.exports = {
    ...
    assignBadges: async function(assignSeasonBadgesRequest) {
        ...
        let topTenScorers = await premiereLeagueDataDao.getTopTenPlayersByStatistic("goals", "2020/2021", 10);
        console.log(JSON.stringify(topTenScorers));
        let topTenAssisters = await premiereLeagueDataDao.getTopTenPlayersByStatistic("assists", "2020/2021", 10);
        console.log(JSON.stringify(topTenAssisters));
